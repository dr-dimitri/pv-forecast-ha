...
Das Optionshauptmenü enthält fünf Bereiche:
...
- **Erweiterte Funktionen:** Prognosehorizont, Neustartcache,
  AC-Wechselrichtergruppen und experimentelles Horizontprofil.
- **Betrieb prüfen:** lokale Prüfung der Wetter-, Mess- und Cachezustände.

Anlage und erweiterte Funktionen haben einen Rückweg zur Übersicht. Setup und
Optionsübersicht nennen bereits gewählte Quellen sowie den Dashboardzustand.
...
Fachtests durchlaufen die angebotenen neuen
...
Die verbleibenden Menüaktionen sind erreichbar;
